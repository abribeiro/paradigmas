...
--numNegativos [] = []
--numNegativos x = if (head x) < 0  then x : else numNegativos tail x



numNegativos :: [Int] -> [Int]
numNegativos [] = []
numNegativos x = if (head x) <0 then head x : numNegativos (tail x) else  numNegativos (tail x)

numNegativos_ :: [Int] -> [Int]
numNegativos_ [] = []
numNegativos_ x =  filter (<0) x
